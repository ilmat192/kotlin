...
fun case_1() {
    ...
    val s: String = <!OVERLOAD_RESOLUTION_AMBIGUITY!><!DEBUG_INFO_EXPRESSION_TYPE("kotlin.collections.MutableList<kotlin.String> & kotlin.collections.MutableList<kotlin.Int> & kotlin.collections.MutableList<kotlin.String>")!>list<!>[0]<!>
}
