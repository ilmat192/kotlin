...
object DIAGNOSTICS_LIST : DiagnosticList("FirErrors") {
    ...
    val SUSPEND by object : DiagnosticGroup("Suspend errors") {
        ...
        val MODIFIER_FORM_FOR_NON_BUILT_IN_SUSPEND_FUN by error<PsiElement>(PositioningStrategy.REFERENCED_NAME_BY_QUALIFIED)
        val MODIFIER_FORM_FOR_NON_BUILT_IN_SUSPEND_FUN_ERROR by error<PsiElement>(PositioningStrategy.REFERENCED_NAME_BY_QUALIFIED)
