...
object DIAGNOSTICS_LIST : DiagnosticList("FirErrors") {
    ...
    val CONTEXT_RECEIVERS_RESOLUTION by object : DiagnosticGroup("Context receivers resolution") {
        val NO_CONTEXT_RECEIVER by error<KtElement> {
            parameter<ConeKotlinType>("contextReceiverRepresentation")
        }
        val MULTIPLE_ARGUMENTS_APPLICABLE_FOR_CONTEXT_RECEIVER by error<KtElement> {
            parameter<ConeKotlinType>("contextReceiverRepresentation")
        }
        val AMBIGUOUS_CALL_WITH_IMPLICIT_CONTEXT_RECEIVER by error<KtElement>()
