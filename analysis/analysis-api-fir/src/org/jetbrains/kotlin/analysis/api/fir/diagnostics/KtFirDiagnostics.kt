...
sealed class KtFirDiagnostic<PSI : PsiElement> : KtDiagnosticWithPsi<PSI> {
    ...
    abstract class ModifierFormForNonBuiltInSuspendFun : KtFirDiagnostic<PsiElement>() {
        override val diagnosticClass get() = ModifierFormForNonBuiltInSuspendFun::class
    }
    ...
    abstract class SynchronizedOnSuspend : KtFirDiagnostic<KtAnnotationEntry>() {
        override val diagnosticClass get() = SynchronizedOnSuspend::class
    }
